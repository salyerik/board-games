...
const initialState: iCommonSliceState = {
	...
	blogPage: {
		items: [
			{
				...
				label: "In this article, we will look at the capabilities of the new starter Kill Team: T'au Empire and the Tau faction in general.",
			...
			},
			{
				...
				label: "An overview of the features of all the bugs in Speed Freeks. We tell you about the board game Adeptus Titanicus and why you should try it.",
			...
			},
			{
				...
				label: "Clan Cultures - Adeptus Titanicus. We tell you about the board game Adeptus Titanicus and why you should try playing it.",
			...
			},
			{
				...
				label: "We tell you about the board game Adeptus Titanicus and why you should try to play it.",
			...
			},
			{
				...
				date: "18.12.2021",
				linkName: "ORKS: DA VEHICLES",
				label: "An overview of the features of all the buggies in the game Speed Freeks. We tell you about the board game Adeptus Titanicus and why you should try to play it.",
		...
		texts: [
			...
			{
				id: 3,
				label: "The Imperial Navy – is the mastery of the middle-distance huddle",
		...
		items: [
			{
				...
				price: 350,
				placeLeft: 7,
				label: "We will gather to find out who was the Mafia and what will happen to the one who was killed."
			},
			{
				id: 2,
				...
				price: 150,
				placeLeft: 7,
				label: "Weekly board games in a variety of games.Meetings are held at anticafes, cafes and libraries."
			},
			{
				id: 3,
