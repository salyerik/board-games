...
import {
	setFromPrice, setToPrice, toggleOnlyStocked, togglePriceSpoiler
...
const PriceFilter: FC = () => {
	...
	const {
		price, isOnlyStocked, isSpoilerActive
	...
	return (
		<section className={'asideCategoryWrapper'}>
			...
			{isSpoilerActive.priceFilter && <>
				...
				<RangeSlider setFromRange={handleFromPrice} setToRange={handleToPrice}
					range={price} valueRange={valueRange} />
