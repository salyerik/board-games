	...
	return (
		<>
			<div className={s.titles}>
				{tabTitle.map((t, i) => (
					<div key={i}
						...
						onClick={() => handleTitleClick(i)}>{t}</div>
				))}
			</div>
			<div className={s.content}>
				...
				{activeTab === 2 &&
					<>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci rem deserunt non fugiat doloribus amet accusamus est asperiores explicabo repudiandae consequuntur dicta architecto nihil odio tempora, facilis velit voluptates animi, quisquam, quasi expedita in! Nihil omnis sapiente laborum, ipsa fuga eveniet, enim molestias totam neque, deserunt error. Voluptatem veniam aliquid fuga saepe molestiae quae magni voluptas sit esse sed, qui, in deleniti aspernatur pariatur doloribus quidem? Ipsum magni adipisci molestiae hic laborum ratione doloremque eaque consequatur qui, error aspernatur nulla veritatis quia at animi minus velit iste. Totam saepe ut molestiae harum possimus itaque, eaque libero nihil praesentium, ex mollitia?</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci rem deserunt non fugiat doloribus amet accusamus est asperiores explicabo repudiandae consequuntur dicta architecto nihil odio tempora, facilis velit voluptates animi, quisquam, quasi expedita in! Nihil omnis sapiente laborum, ipsa fuga eveniet, enim molestias totam neque, deserunt error. Voluptatem veniam aliquid fuga saepe molestiae quae magni voluptas sit esse sed, qui, in deleniti aspernatur pariatur doloribus quidem? Ipsum magni adipisci molestiae hic laborum ratione doloremque eaque consequatur qui, error aspernatur nulla veritatis quia at animi minus velit iste. Totam saepe ut molestiae harum possimus itaque, eaque libero nihil praesentium, ex mollitia?</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci rem deserunt non fugiat doloribus amet accusamus est asperiores explicabo repudiandae consequuntur dicta architecto nihil odio tempora, facilis velit voluptates animi, quisquam, quasi expedita in! Nihil omnis sapiente laborum, ipsa fuga eveniet, enim molestias totam neque, deserunt error. Voluptatem veniam aliquid fuga saepe molestiae quae magni voluptas sit esse sed, qui, in deleniti aspernatur pariatur doloribus quidem? Ipsum magni adipisci molestiae hic laborum ratione doloremque eaque consequatur qui, error aspernatur nulla veritatis quia at animi minus velit iste. Totam saepe ut molestiae harum possimus itaque, eaque libero nihil praesentium, ex mollitia?</p>
					</>}
				{activeTab === 3 &&
